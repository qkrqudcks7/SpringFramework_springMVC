...
public interface BoardMapper {
								// dual 은 오라클에서 임시테이블을 의미                // 임시테이블에 저장된 값을 content_idx에 담겠다      // 이 쿼리문들이 실행되기 전에 실행하겠다 . 정수타입 지정
	...
	@Select("select a2.user_name as content_writer_name, to_char(a1.content_date,'YYYY-MM-DD') as content_date , a1.content_subject , a1.content_text , a1.content_file , a1.content_writer_idx "
			+ "from content_table a1 , user_table a2 where a1.content_writer_idx=a2.user_idx and content_idx=#{content_idx}")
